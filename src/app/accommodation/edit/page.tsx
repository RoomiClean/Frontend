  ...
  return (
    <div className="min-h-[calc(100dvh-68px)] py-8">
      <div className="flex flex-col items-center gap-16 w-full max-w-[472px] px-4 mx-auto">
        <DisplayH3 className="lg:!text-[28px] xl:!text-[32px]">숙소 정보 수정하기</DisplayH3>
        {/* 숙소정보 */}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <Input placeholder="우편번호" {...register('zipCode')} disabled className="!w-24" />
                <Input
                  placeholder="주소"
                  {...register('address', {
                    required: '주소를 입력해주세요',
      ...
      {/* 저장/취소 버튼 */}
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-[472px]">
