    ...
    <RoomMainTemplate>
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6">
          {/* 회원 정보 카드 */}
          <section className="w-full rounded-[20px] bg-neutral-100 border border-neutral-200 shadow-[0_6px_15px_0_rgba(0,0,0,0.1)] px-8 py-8">
            ...
            <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex-1 grid grid-cols-1 sm:grid-cols-[50px_1fr] gap-y-3 gap-x-8 w-full">
                  <BodySmall className="text-neutral-600">아이디</BodySmall>
                  <TitleDefault className="text-neutral-1000">{user.email}</TitleDefault>
            ...
            <ul className="flex flex-col gap-2">
              {accountMenus.map(menu => (
                <li key={menu.href}>
                  <Link
                    href={menu.href}
                    className="flex items-center justify-between text-neutral-800 hover:text-primary-400"
                  >
