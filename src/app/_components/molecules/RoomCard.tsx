...
export default function AccommodationCard({
  ...
  return (
    <div className="rounded-[16px] bg-neutral-100 md:py-6 py-4 px-4 hover:border hover:border-neutral-200 hover:shadow-[0_6px_15px_0_rgba(0,0,0,0.2)] transition-all">
